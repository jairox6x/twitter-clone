<div class="relative mb-4 sticky top-0">
    <input type="text" placeholder="Search Twitter" class="placeholder-gray-600 shadow-lg text-sm w-full px-8 py-2 rounded-full bg-gray-300 outline-none
    focus:shadow-outline">
    <svg viewBox="0 0 24 24" class="w-4 text-gray-600 fill-current absolute search-bar-icon">
        <g>
...
<div class="wrapper-content sticky top-0">
    <div class="flex justify-between px-4 bg-gray-100 pt-4 rounded-t-lg border-b">
        <h3 class="font-black mb-2">Trends for you</h3>
        <svg viewBox="0 0 24 24" class="fill-current text-green-500 w-6 h-6">
            <g>
