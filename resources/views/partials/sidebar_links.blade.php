<div class="sticky top-0">
    <section class="logo-container mb-6 mt-2">
        <header class="ml-4">
            <a href="{{route('home')}}" class="hover:bg-blue-100 rounded-full logo flex items-center px-1 w-12 h-12 transition ease-in-out duration-100">
                <div class="w-full flex items-center">
                    <svg viewBox="0 0 24 24" class="fill-current text-blue-500 w-8">
                        <g>
    ...
    <nav>
        <ul>
            <li class="mb-4">
                <a href="#">
                    <div class="content flex">
                        <div class=" {{request()->is('home*') ? 'text-green-600' : ''}} flex font-bold text-lg hover:text-green-500 hover:bg-green-200 px-4 rounded-full py-2
                    transition
                    ease-in-out
                    duration-100">
                            <svg viewBox="0 0 24 24" class="fill-current mr-4 h-6 w-6">
                                <g>
                                    <path d="M22.46 7.57L12.357 2.115c-.223-.12-.49-.12-.713 0L1.543 7.57c-.364.197-.5.652-.303 1.017
                    .135.25.394.393.66.393.12 0 .243-.03.356-.09l.815-.44L4.7 19.963c.214 1.215 1.308 2.062 2.658 2.062h9.282c1.352 0 2.445-.848 2.663-2.087l1.626-11.49.818.442c.364.193.82.06 1.017-.304.196-.363.06-.818-.304-1.016zm-4.638 12.133c-.107.606-.703.822-1.18.822H7.36c-.48 0-1.075-.216-1.178-.798L4.48 7.69 12 3.628l7.522 4.06-1.7 12.015z"></path>
            ...
            <li class="mb-4">
                <a href="#">
                    <div class="content flex">
                        <div class="flex font-bold text-lg hover:text-green-500 hover:bg-green-200 px-4 rounded-full py-2 transition ease-in-out duration-100">
                            <svg viewBox="0 0 24 24" class="fill-current mr-4 h-6 w-6">
                                <g>
            ...
            <li class="mb-4">
                <a href="#">
                    <div class="content flex">
                        <div class="flex font-bold text-lg hover:text-green-500 hover:bg-green-200 px-4 rounded-full py-2 transition ease-in-out duration-100">
                            <img src="{{auth()->user()->avatar}}" alt="avatar" class="rounded-full w-6">
                            <span class="hidden md:inline ml-4">Profile</span>
                        </div>
                    </div>
    ...
    <button class="bg-green-500 w-10/12 py-3 text-white font-bold rounded-full shadow-lg focus:outline-none focus:shadow-outline hover:bg-green-600 transition ease-in-out
    duration-100">Tweet
    </button>
</div>