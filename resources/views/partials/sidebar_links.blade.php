<div class="sticky top-0">
    <section class="logo-container mb-6 mt-2">
        <header class="container mx-auto">
            <div class="logo ml-4">
                <svg viewBox="0 0 24 24" class="fill-current text-blue-500 w-8 hover:bg-blue-200 rounded-full">
                    <g>
    ...
    <button class="bg-green-500 w-10/12 py-3 text-white font-bold rounded-full shadow-lg focus:shadow-outline hover:bg-green-600 transition ease-in-out duration-100">Tweet</button>
</div>