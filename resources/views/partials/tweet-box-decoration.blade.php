<footer class="flex items-center justify-between">
    <div class="tags flex items-center ml-16">
        <svg viewBox="0 0 24 24" class="fill-current text-green-500 mr-4 h-5 w-5">
            <g>
    ...
    <button type="submit" class="shadow-lg bg-green-500 shadow px-4 py-2 text-white font-bold rounded-full hover:bg-green-600 transition ease-in-out duration-75">Tweet</button>
</footer>