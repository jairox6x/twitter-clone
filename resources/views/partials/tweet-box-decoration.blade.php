<footer class="flex items-center justify-between">
    <div class="tags flex items-center">
        <svg viewBox="0 0 24 24" class="fill-current text-blue-900 mr-4 h-6 w-6">
            <g>
    ...
    <button type="submit" class="bg-blue-500 shadow px-4 py-2 text-white font-bold rounded-full hover:bg-blue-600 transition ease-in-out">Let them know!</button>
</footer>